...
1. 01_load_TSA.R
  ...
  - Requires Provincial Grizzly Bear CE geodatabase, which includes LU summary datat and GBPUs. available from Provincial CE program.

2. run_all_AOI.R:

  Identify Area of Interest analysis parameters 
  - AOI name and GBPUs to consider for the anlysis
  - Set % overlap for LUs that overlap AOI boundary
  - Identify which CE intdicators to consider - main ones are listed, but a subset can be identified
